...
local Button20Action = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/KJASSH/REFS/main/ZAGANG"))()
end
...
createButton("Zagnz X", Button20ction)
createButton("NovoAprendiz", Button21ction)
